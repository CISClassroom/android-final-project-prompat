...
class KotlinActivity : AppCompatActivity() {
    private val TAG: String = "List Kotlin"
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kotlin)


        Firebase.database.reference.child("kotlin").addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val listView: ListView = findViewById(R.id.listView_kotlin)
                ...
                listView.setOnItemClickListener { parent, view, position, id ->
                    ...
                    val i = Intent(this@KotlinActivity,Pattern2Activity::class.java)
